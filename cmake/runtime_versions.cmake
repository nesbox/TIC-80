...
if(EXISTS "${CMAKE_SOURCE_DIR}/vendor/LuaJIT/src/luajit_rolling.h")
    file(STRINGS "${CMAKE_SOURCE_DIR}/vendor/LuaJIT/src/luajit_rolling.h" LUAJIT_VERSION_LINE REGEX "^#define LUAJIT_VERSION[ \t]+\"[^\"]+\"")
    if(LUAJIT_VERSION_LINE)
        string(REGEX REPLACE ".*\"([^\"]+)\".*" "\\1" LUAJIT_VERSION "${LUAJIT_VERSION_LINE}")
        set(TIC_RT_LUA "${LUAJIT_VERSION}")
    endif()
endif()
