...
if(DEFAULT_STARTUP_SCREEN STREQUAL "MENU")
    target_compile_definitions(tic80studio PUBLIC DEFAULT_STARTUP_SCREEN_MENU)
    message("DEFAULT_STARTUP_SCREEN: MENU")
else()
    message("DEFAULT_STARTUP_SCREEN: CONSOLE")
endif()
