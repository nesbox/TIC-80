...
if(BUILD_SDL)
    ...
    if(EMSCRIPTEN)
        ...
        # runs there must not corrupt the heap here: 4M of stack, plus the check
        # that makes the next overflow an error rather than corruption.
        ...
        set_target_properties(${TIC80_TARGET} PROPERTIES LINK_FLAGS "-s WASM=1 -s USE_SDL=2 -s ALLOW_MEMORY_GROWTH=1 -s FETCH=1 -s STACK_SIZE=4194304 -s STACK_OVERFLOW_CHECK=1 --pre-js ${CMAKE_SOURCE_DIR}/build/html/prejs.js -lidbfs.js")
