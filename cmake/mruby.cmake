...
if(BUILD_WITH_RUBY)
    ...
    elseif(SYMBIAN)
        set(MRUBY_CONFIG ${MRUBY_BUILDDIR}/tic_symbian.rb)
    else()
    ...
    ExternalProject_Add(mruby_vendor
        ...
        BUILD_COMMAND
            ${RAKE} clean all "MRUBY_CONFIG=${MRUBY_CONFIG}"
                ...
                "TARGET_AR=\"${CMAKE_AR}\""
                "TARGET_CFLAGS=-isystem $<JOIN:$<TARGET_PROPERTY:tic80,INCLUDE_DIRECTORIES>, -isystem > ${SYMBIAN_DEFINITIONS} ${CMAKE_C_FLAGS} ${CMAKE_C_FLAGS_${BUILD_TYPE_UC}}"
                ...
                "SYMBIAN_PRODUCT_INCLUDE=${SYMBIAN_PRODUCT_INCLUDE}"
